...
# tambah tabel
tabel_odoo = ['sale_order', 'purchase_order', 'stock_quant', 'stock_picking', 'stock_move', 'stock_move_line', 'product_product', 'product_template', 'stock_valuation_layer', 'stock_picking_type', 'res_partner'] 
